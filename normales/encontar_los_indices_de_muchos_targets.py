...
retornar los pares de indices que formal los targets.
"""
...
def encontrar_indices(lista_numeros:List, target:int)->List[int]:
    ...
    while i < len(lista_numeros):
        ...
        if diferencia in dic_indices:
            list_intermedia.append(dic_indices[diferencia])
            list_intermedia.append(i)
            dict_retorno[cantidad_indices] = list_intermedia.copy()
            cantidad_indices += 1
            list_intermedia.clear()
